...
def main():
    """主函数"""
    # 文件路径配置 - 你可以修改这些路径
    base_dir = "/home/zbm/xjd/NPC-master/dataset/incomplete_description_noise_MSCOCO/annotations/scan_split"
    ...
    # 输出文件夹 - 你可以指定任何文件夹
    output_dir = "/home/zbm/xjd/NPC-master/dataset/incomplete_description_noise_MSCOCO/annotations/dfii_reports"  # 修改为你想要的输出文件夹
