...
def main():
    """主函数"""
    # 文件路径配置 - 你可以修改这些路径
    base_dir = "/home/zbm/xjd/NPC-master/dataset/Entity_Referential_Error_noise_5error_MSCOCO/annotations/scan_split"
    
    # 输入文件
    file1 = "0_noise_train_caps.txt"
    file2 = "0.6_noise_train_caps.txt"
    
    # 输出文件夹 - 你可以指定任何文件夹
    output_dir = "/home/zbm/xjd/NPC-master/dataset/Entity_Referential_Error_noise_5error_MSCOCO/annotations/dfii_reports"  # 修改为你想要的输出文件夹
