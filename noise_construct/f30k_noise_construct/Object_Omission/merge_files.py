...
if __name__ == "__main__":
    ...
    INPUT_DIR = '/path/noise_construct/f30k_noise_construct/Object_Omission/train_flickr'
    
    # Output file (merged complete file)
    OUTPUT_FILE = '/path/dataset/Object_Omission_noise_f30k/annotations/scan_split/1.0_noise_train_caps.txt'
