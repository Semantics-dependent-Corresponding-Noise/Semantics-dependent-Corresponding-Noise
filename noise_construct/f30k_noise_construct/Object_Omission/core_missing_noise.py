...
file_path = '/path/dataset/core_missing_Error_noise_f30k/annotations/scan_split/0_noise_train_caps.txt'
...
# Path to noise file
noise_file_path = '/path/dataset/core_missing_Error_noise_f30k/annotations/scan_split/1.0_noise_train_caps.txt'
...
if len(noise_texts) < len(raw_texts):
    print(f"Warning: Number of noise texts ({len(noise_texts)}) is fewer than original texts ({len(raw_texts)})")
...
for replace_ratio in replace_ratios:
    ...
    # Output file path
    output_file_path = f'/path/dataset/core_missing_Error_noise_f30k/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
    ...
    print(f"Texts with replacement ratio {replace_ratio} have been saved to {output_file_path}")
    print(f"Number of replaced texts: {num_to_replace}/{num_texts}")
