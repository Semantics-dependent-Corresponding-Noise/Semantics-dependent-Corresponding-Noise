...
noise_file_path = '/path/dataset/Object_Omission_noise_5error_f30k/annotations/scan_split/1.0_noise_train_caps.txt'
...
# Output file path
output_file_path = f'/path/dataset/Object_Omission_noise_5error_f30k/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
