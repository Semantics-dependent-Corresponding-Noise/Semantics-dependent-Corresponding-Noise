...
# Configure KimiChat API Key and API Endpoint
client = OpenAI(
    api_key="yours api",
...
# Reading Text Files
file_path = '/path/dataset/Entity_Referential_Error_noise_f30k/annotations/scan_split/test_caps.txt'
...
i = 0
output_test_file_path = '/path/dataset/Entity_Referential_Error_noise_f30k/annotations/test_caps.txt'
...
while modified_count < target_modified:
    ...
    if not remaining_indices:
        print("There is no further text available for modification.")
        break
...
print(f"Actual quantity of noise text generated: {modified_count}")
...
print(f"The original text and the amended text have been saved to {output_test_file_path}")
