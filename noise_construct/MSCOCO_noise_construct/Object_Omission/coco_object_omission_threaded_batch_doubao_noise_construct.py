...
TRAIN_IDS_PATH = '/path/dataset/Object_Omission_noise_MSCOCO/annotations/scan_split/train_ids.txt'
OUTPUT_DIR = '/path/noise_construct/MSCOCO_noise_construct/Object_Omission/train_file'
