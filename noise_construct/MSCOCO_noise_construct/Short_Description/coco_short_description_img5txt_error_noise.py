...
file_path = '/path/dataset/Short_Description_noise_5error_MSCOCO/annotations/scan_split/0_noise_train_caps.txt'
with open(file_path, 'r', encoding='utf-8') as f:
    raw_texts = f.readlines()
raw_texts = [text.strip() for text in raw_texts]

# Noise file path
noise_file_path = '/path/dataset/Short_Description_noise_5error_MSCOCO/annotations/scan_split/1.0_noise_train_caps.txt'
...
# Output file path
output_file_path = f'/path/dataset/Short_Description_noise_5error_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
