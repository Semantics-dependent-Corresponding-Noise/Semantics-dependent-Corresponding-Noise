...
| `coco_short_description_noise_construct.py` | Generates noise for each split file sequentially. |
| `coco_short_description_noise_complete_construct.py` | Compares the noise file with the original, re-modifies identical lines to ensure 100% noise, and saves the final file. |
| `coco_short_description_test_noise_construct.py` | Generates noise for the test set directly. |
| `coco_short_description_noise.py` | Generates partial error noise (some descriptions contain errors). |
| `coco_short_description_img5txt_error_noise.py` | Generates all-error noise (all descriptions contain errors). |
...
Run the command `python coco_short_description_noise_construct.py`.
...
Run the command `python coco_short_description_noise_complete_construct.py`.
...
**Generate Test Noise**
Run the command `python coco_short_description_test_noise_construct.py`.
...
Run the command `python coco_short_description_noise.py`.
...
**2. All Error (Total)**
Run the command `python coco_short_description_img5txt_error_noise.py`.
