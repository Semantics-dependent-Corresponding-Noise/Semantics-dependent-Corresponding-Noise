...
| `f30k_high_level_semantic_confusion_noise.py` | Generates partial error noise. |
| `f30k_high_level_semantic_confusion_img5txt_error_noise.py` | Generates all error noise. |
...
**1. Generate Training Set Noise (100% Error)**
   Command: `python f30k_high_level_semantic_confusion_noise_construct.py`
...
**2. Generate Test Set Noise**
   Command: `python f30k_high_level_semantic_confusion_test_noise_construct.py`
...
- **Partial Error (Mixed)**
  Command: `python f30k_high_level_semantic_confusion_noise.py`
...
- **All Error (Total)**
  Command: `python f30k_high_level_semantic_confusion_img5txt_error_noise.py`
