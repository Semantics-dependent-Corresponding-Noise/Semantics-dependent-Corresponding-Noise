...
# Input file path
file_path = '/path/dataset/k_means_MSCOCO/annotations/scan_split/test_caps.txt'
...
# Output file path
output_file = '/path/dataset/k_means_MSCOCO/annotations/scan_split/test_caps_kmeans.txt'
