...
# Noise file path
noise_file_path = '/path/dataset/k_means_MSCOCO/annotations/scan_split/1.0_noise_train_caps.txt'
...
for replace_ratio in replace_ratios:
    ...
    # Output file path
    output_file_path = f'/path/dataset/k_means_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
