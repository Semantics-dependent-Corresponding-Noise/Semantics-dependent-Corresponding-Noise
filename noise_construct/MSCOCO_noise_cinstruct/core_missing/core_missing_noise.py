...
# Read raw text data
file_path = '/path/dataset/core_missing_Error_noise_coco/annotations/scan_split/0_noise_train_caps.txt'
with open(file_path, 'r', encoding='utf-8') as f:
    raw_texts = f.readlines()
raw_texts = [text.strip() for text in raw_texts]

# Path to noise file
noise_file_path = '/path/dataset/core_missing_Error_noise_coco/annotations/scan_split/1.0_noise_train_caps.txt'
...
for replace_ratio in replace_ratios:
    ...
    # Output file path
    output_file_path = f'/path/dataset/core_missing_Error_noise_coco/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
