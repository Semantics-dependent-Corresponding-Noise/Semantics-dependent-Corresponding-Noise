...
if __name__ == "__main__":
    # ==================== 配置参数 ====================
    # 输入目录（包含分割文件的目录）
    INPUT_DIR = '/home/zbm/xjd/NPC-master/MSCOCO_noise_cinstruct/core_missing/test_testid'
    
    # 输出文件（合并后的完整文件）
    OUTPUT_FILE = '/home/zbm/xjd/NPC-master/dataset/core_missing_Error_noise_coco/annotations/scan_split/test_caps_core.txt'
